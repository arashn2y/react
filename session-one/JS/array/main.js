import { colors, students, numbers } from "../data.js";
...
// result = numbers.find(number => number === 12);
...
// result = numbers.some((number) => number > 9);
...
// students.sort((firstStudent, secondStudent) => firstStudent.age - secondStudent.age);
